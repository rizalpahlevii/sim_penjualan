...
<div class="isi-content">
    <form action="crud/simpan_jenis_barang.php" method="POST">
        <table>
            ...
            <tr>
                <td><input type="text" name="id_jenis" class="text disable" autocomplete="off" id="id_brg"
            ...
            <tr>
                <td><input type="text" name="nama_jenis" class="text" autocomplete="off" required="" id="nama_brg"
                           value="<?= $row['nama_jenis']; ?>"></td>
            </tr>
