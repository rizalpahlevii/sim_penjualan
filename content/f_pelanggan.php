...
<div class="isi-content">
    <form action="crud/simpan_pelanggan.php" method="POST">
        <table>
            ...
            <tr>
                <td><input type="text" name="id_pelanggan" class="text disable" autocomplete="off" id="di_pelanggan"
                           value="<?php echo $kodebarang; ?>" readonly></td>
            </tr>
            ...
            <tr>
                <td><input type="text" name="nama_pelanggan" class="text" autocomplete="off" required=""
                           id="nama_pelanggan" value="<?= $row['nama']; ?>"></td>
            </tr>
            ...
            <tr>
                <td><input type="text" name="alamat" class="text" autocomplete="off" required="" id="alamat"
                           value="<?= $row['alamat']; ?>"></td>
            </tr>
            ...
            <tr>
                <td><input type="text" name="no_telp" class="text" autocomplete="off" required="" id="no_telp"
            ...
            <tr>
                <td><input type="email" name="email" class="text" autocomplete="off" required="" id="email"
                           value="<?= $row['email']; ?>"></td>
            </tr>
