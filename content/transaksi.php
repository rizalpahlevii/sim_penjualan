	...
	<form action="crud/simpan_transaksi.php" method="POST">
		...
		<table>
			<tr>
				...
				<td><br></td>
				<td><input type="text" name="id_transaksi" id="id_transaksi" class="text disable" readonly value="<?= $nomot; ?>"></td>
			</tr>
			<tr>
				<td><label>Tanggal Transaksi</label></td>
				<td><br></td>
				<td><input type="text" name="tanggal" id="tanggal" class="text disable" value="<?= $tgl; ?>" readonly></td>
		...
		<table>
			<tr>
				<td><label><center>Kategori</center></label></td>
		...
		<table>
			<tr>
				<td><center><label>ID Barang</label></center></td>
				<td><center><label>Nama Barang</label></center></td>
				<td><center><label>Harga</label></center></td>		
			</tr>
			<tr>
				<td>
					<input type="text" name="id_barang" class="textkecil" id="id_barang" required="" autocomplete="off" onkeyup="idb()" required="">
				</td>
			...
			<tr>
				<td>
					<input type="text" name="jumlah" id="jumlah" class="textkecil" required="" autocomplete="off" onkeyup="t()">
				</td>
				<td>
					<input type="text" name="total" id="total" class="textkecil disable" readonly>
				</td>
				<td>
					<center><input type="button" name="simpan" class="simpantrans btn-biru" value="Simpan" onclick="simpan_detail()"></center>
				</td>
			</tr>
		...
		<table>
			<tr>
				<td><center><label for="subtotal">Sub Total</label></center></td>
				<td><center><label for="diskon">Diskon</label></center></td>
				<td><center><label for="totalbayar">Total Bayar</label></center></td>
			...
			<tr>
				<td><center><label for="bayar">Bayar</label></center></td>
				<td><center><label for="kembali">Kembali</label></center></td>
			</tr>
