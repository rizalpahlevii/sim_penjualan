            ...
            <table class="tabel98">
                ...
                foreach ($qw as $tamp_pelanggan) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="crud/hapus_pelanggan.php?idp=<?= $tamp_pelanggan['id_pelanggan']; ?>"
                               class="btn btn-merah" onclick="return confirm('Yakin Ingin Menghapus Data ?')"><i
                                        class="fa fa-trash-alt"></i> Hapus</a>
                            <a href="index.php?p=f_pelanggan&id_pelanggan=<?= $tamp_pelanggan['id_pelanggan']; ?>"
                               class="btn btn-kuning"><i class="fa fa-pen"></i> Edit</a>
                        </td>
                    </tr>
                    <?php
                }
