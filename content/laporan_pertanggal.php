        ...
        <div class="divtabel">
            <form action="index.php?p=laporan_pertanggal" method="POST">
                <table>
                    ...
                    <tr>
                        <td>
                            <input type="date" name="tgl_awal" class="text" id="tgl_awal" style="width: 200px;"
                                   value="<?php echo $_POST['tgl_awal']; ?>">
                        </td>
                        <td>s/d</td>
                        <td>
                            <input type="date" name="tgl_akhir" class="text" id="tgl_akhir" style="width: 200px;"
                                   value="<?php echo $_POST['tgl_akhir']; ?>">
                        </td>
                        <td>
